...
def handleWin():
    ...
    if('red' in message and playerType=='player2'):
        rollButton.destroy()
    elif('yellow' in message and playerType=='player1'):
        rollButton.destroy()
...
def recivedMsg():
    ...
    while True:
        ...
        if('player1Turn' in message or 'player2Turn' in message):
            ...
            if('player1Turn' in message and playerType=='player1'):
                rollButton=Button(gameWindow, text='Roll Dice', fg='black',font=('Chalkboard SE',15), bg='blue', command=rollDice, width=20,height=5)
                playerTurn=True
                rollButton.place(x=screen_width/2-80, y=screen_height/2+250)
            elif('player2Turn' in message and playerType=='player2'):
                rollButton=Button(gameWindow, text='Roll Dice', fg='black',font=('Chalkboard SE',15), bg='blue', command=rollDice, width=20,height=5)
